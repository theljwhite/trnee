...
export default function Sidebar() {
  return (
    <div className="hidden text-center lg:block fixed bottom-0 top-0 left-0 w-16 bg-zinc-800/60 z-50 shadow">
      ...
      {/* TODO: MAP ANY USER TOURNIES HERE  */}
      <a className="w-full cursor-pointer h-16 flex items-center justify-center hover:bg-zinc-700 transition ease-in-out duration-200">
